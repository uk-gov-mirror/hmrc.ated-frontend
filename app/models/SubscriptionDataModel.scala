...
object EditContactDetails {
  given formats: OFormat[EditContactDetails] = Json.format[EditContactDetails]
}
...
object EditContactDetailsEmail {
  given formats: OFormat[EditContactDetailsEmail] = Json.format[EditContactDetailsEmail]
}
